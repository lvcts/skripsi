                        ...
                        <?php foreach ($getdata as $user) : ?>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control" aria-label="With textarea" id="deskripsi_pano1" name="deskripsi_pano1"><?= $user['deskripsi_pano1'] ?></textarea>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <label for="exampleInputEmail1" class="form-label">Deskripsi</label>
                                    <textarea class="form-control" aria-label="With textarea" id="deskripsi_pano2" name="deskripsi_pano2"><?= $user['deskripsi_pano2'] ?></textarea>
