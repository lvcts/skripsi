...
<body>
    ...
    <section class="sub_header" style="background-color: gray;">
        <div class="sub_header_content">
            <div class="intro_title error">
                <h1 class="animated fadeInDown">404</h1>
                <p class="animated fadeInDown">Oops!! Page not found</p>
                <a href="<?= route_to('Home'); ?>" class="animated fadeInUp button_intro">Back to home</a> <a href="<?= route_to('listWisata'); ?>"" class=" animated fadeInUp button_intro">View All</a>
            </div>
        </div>
    </section><!-- End Section -->
