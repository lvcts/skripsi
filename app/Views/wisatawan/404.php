...
<head>
    ...
    <!-- Google web fonts -->
    <link href="<?= base_url('http://fonts.googleapis.com/css?family=Varela+Round'); ?>" rel='stylesheet' type='text/css'>
    <link href="<?= base_url('http://fonts.googleapis.com/css?family=Lato:300,400,700'); ?>" rel='stylesheet" type=' text/css'>
    <link href="<?= base_url('http://fonts.googleapis.com/css?family=Gochi+Hand'); ?>" rel='stylesheet" type=' text/css'>
    ...
    <section class="sub_header" id="bg_general">
        <div class="sub_header_content">
            <div class="intro_title error">
                ...
                <a href="index.html" class="animated fadeInUp button_intro">Back to home</a> <a href="rooms_list.html" class="animated fadeInUp button_intro outline">View all rooms</a>
            </div>
        </div>
    </section><!-- End Section -->
    ...
    <div class="container margin_60">
        <div class="row">
            <div class="col-md-3 col-sm-6 text-center">
                <p>
                    <a href="#"><img src="img/about_2.jpg" alt="Pic" class="img-responsive styled"></a>
                </p>
                <h4>Charming rooms</h4>
                <p>
            ...
            <div class="col-md-3 col-sm-6 text-center">
                <p>
                    <a href="#"><img src="img/about_1.jpg" alt="Pic" class="img-responsive styled"></a>
                </p>
                <h4>A beautiful contest</h4>
                <p>
                    Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex.
                </p>
            </div>
            <div class="col-md-3 col-sm-6 text-center">
                <p>
                    <a href="#"><img src="img/about_3.jpg" alt="Pic" class="img-responsive styled"></a>
                </p>
                <h4>It's time to relax</h4>
                <p>
                    Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex.
                </p>
            </div>
            <div class="col-md-3 col-sm-6 text-center">
                <p>
                    <a href="#"><img src="img/activities.jpg" alt="Pic" class="img-responsive styled"></a>
                </p>
                <h4>Tons of activities</h4>
                <p>
                    Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex.
                </p>
            </div>
